package com.lingshui.order.service.impl;

import com.lingshui.goods.feign.SkuFeign;
import com.lingshui.order.dao.OrderItemMapper;
import com.lingshui.order.dao.OrderMapper;
import com.lingshui.order.pojo.Order;
import com.lingshui.order.pojo.OrderItem;
import com.lingshui.order.service.OrderService;
import com.lingshui.user.feign.UserFeign;
...
//        删除Redis中的订单记录
        redisTemplate.boundHashOps("Order").delete(transaction_id);
    }
}
